...
const Form = () => {
    return (
        <div className='border-1 border-white w-full h-full lg:p-8 p-5 rounded-3xl'>
            <form action="submit" className='w-full flex flex-col items-center gap-8'>
                <div className="dts flex flex-col md:flex-row w-full md:justify-between gap-4">
                    <div className="name flex flex-col w-full">
                        ...
                        <input type="text" placeholder='Enter your full name' className='w-full px-2 py-2 rounded-sm bg-white text-black font-secondary outline-none text-md' />
                    </div>
                    <div className="contact flex flex-col w-full">
                        <label htmlFor="contact" className='text-xl mb-2 font-secondary'>
                            Contact
                        </label>
                        <input type="number" placeholder='Enter your contact no.' className='w-full px-2 py-2 rounded-sm bg-white text-black font-secondary outline-none text-md' />
                    </div>
                </div>
                <div className="dts flex flex-col md:flex-row w-full md:justify-between gap-4">
                    <div className="email flex flex-col w-full">
                        ...
                        <input type="email" placeholder='Enter your email' className='w-full px-2 py-2 rounded-sm bg-white text-black font-secondary outline-none text-md' />
                    </div>
                    <div className="project flex flex-col w-full">
                        <label htmlFor="Project-Type" className='text-xl mb-2 font-secondary'>
                            Project Type
                        </label>
                        <input type="text" placeholder='Enter your project type' className='w-full px-2 py-2 rounded-sm bg-white text-black font-secondary outline-none text-md' />
                    </div>
                </div>
                <div className="message w-full">
                    <label htmlFor="message" className='text-xl font-secondary'>Message</label>
                    <textarea name="message" id="message" rows={4} placeholder='Share your thaughts !' className='w-full px-2 py-2 rounded-sm bg-white text-black font-secondary outline-none text-md'></textarea>
                </div>
