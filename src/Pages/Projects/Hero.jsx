                            ...
                            return (
                                <div key={idx} className="card group flex bg-transparent flex-col overflow-hidden rounded-md">
                                    <a href={elem.link} target="_blank" rel="noopener noreferrer" className='relative group rounded-xl overflow-hidden w-full'>
                                        <div className="circle h-20 w-20 hidden rounded-full text-black text-xl top-[30%] left-[30%] md:left-[40%] md:top-[30%] bg-white absolute translate-x-1/2 translate-y-1/2 z-30 group-hover:flex items-center justify-center font-primary hover:bg-black hover:text-white transition-all duration-300">
                                            <h1>open</h1>
                                        </div>
