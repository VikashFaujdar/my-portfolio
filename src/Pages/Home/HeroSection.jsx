...
import Me from '../../assets/Myfoto1.png'
...
const HeroSection = () => {
    ...
    return (
        <div className='flex min-h-screen items-center justify-center text-white pt-25 pb-10  lg:py-30'>
            <div ref={HeroRef} className="container  flex flex-col md:flex-row gap-10 items-center justify-between px-3 lg:px-5">
                <div className="Heroleft w-full md:w-[45%] lg:w-[45%] h-full ">
                    ...
                    <h1 className='text-[10vw] Title sm:text-4xl md:text-4xl lg:text-5xl font-primary font-medium md:py-3 leading-[1.2]'>I am Vikash Kumar a {<TypeWriter />} Developer Based in India</h1>
                    ...
                    <div className="btns flex items-center justify-start py-5">
                        ...
                        <Link to={'/contact'} ><button className='hidden font-secondary md:block relative cursor-pointer border-2 border-white px-4 md:px-5 py-1 bg-white text-black hover:text-white md:text-xl text-md transition-all group duration-300 overflow-hidden z-20 rounded-sm hover:bg-transparent mr-10'>Hire Me
                        ...
                        <Link to={'projects'}>
                            <button className='font-secondary hidden md:block text-md  relative text-xl overflow-hidden group cursor-pointer pb-1'>My Projects
