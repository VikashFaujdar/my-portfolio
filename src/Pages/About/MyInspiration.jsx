        ...
        <div className='py-5 md:py-10'>
            <div className="container flex flex-col gap-10 px-3 lg:px-5 py-10">
                ...
                <div className="flex flex-col md:flex-row gap-5 justify-between items-start">
                    <h2 className='text-xl font-secondary text-zinc-800'>As I immerse deeper into the world of UX/UI design, I'm particularly excited about the potential of integrating sustainable practices into digital design, thereby embedding a layer of environmental responsibility directly into the user experience.</h2>
                    <h2 className='text-xl font-secondary text-zinc-800'>I dream of contributing to projects that not only look good but also do good — for people and the planet. I'm also keen on exploring how AI can further personalize user experiences without losing the human touch.</h2>
                </div>
            </div>
        </div>
    )
